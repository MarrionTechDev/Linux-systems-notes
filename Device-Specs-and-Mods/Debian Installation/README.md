...
- Set up users and passwords. Set a password for 'root', the system administrative account. (Left blank and continue to disable direct root login and get sudo privileges)
